...
export const rectangleCollision = (r1: DisplayObject, r2: DisplayObject): string | undefined => {
...
export const hitTestRectangle = (r1: DisplayObject, r2: DisplayObject, global = false): boolean => {
  let hit = false,
    vx: number,
    vy: number;
